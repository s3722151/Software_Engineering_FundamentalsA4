	...
	{	
		...
		return true;
		 ...
		 public static void main(String[]args){
			...
			String[] skills = {"SQl","Access", "Microsoft"};  // @@ This is IMPORTANT to initialise array 
...
//		 INPUT VALID - Calculation Function 1  & 2
...
//			Calculation Function 1 Condition 3:Check if the jobPosterAddress is in the correct format 
			public boolean invalidAddress() {
				//Regex: ([A-Z]{1}[A-Za-z\s]+,{1})(\s[A-Z]{1}[A-Za-z\s]+,{1})(\s[A-Z]{1}[A-Za-z\s]+.{1});
